...
```bash
python scripts/run_seed_sweep.py --config configs/experiments/smoke_cstr.yaml --seeds 0 1 2 3 4 --output results/seed_sweep_cstr
```
...
Combined_linear reached the >= 0.70 per-seed win-rate threshold on 0 of 5 seeds.
...
| ood_feed_temperature_spike | 0.000000 | 0.000000 |
| ood_inflow_spike | 0.000000 | 0.000000 |
| ood_reaction_rate_shift | 0.000000 | 0.000000 |
| ood_unsafe_temperature_event | 0.000000 | 0.000000 |
